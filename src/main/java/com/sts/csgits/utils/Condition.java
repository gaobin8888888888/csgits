...
public class Condition {
    ...
    //排序字符串，格式如： create_time desc , id asc
    private StringBuilder sortBuilder = new StringBuilder();
    ...
    public String getMapConditionsString() {
        ObjectMapper mapper = new ObjectMapper();
        try {
            return mapper.writeValueAsString(mapConditions);
        } catch (Exception e) {
